...
public final class CityScoreServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.nils.grpc.cityscore.CityScoreRequest,
      com.nils.grpc.cityscore.CityScoreResponse> getCalculateCityScoreMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "calculateCityScore",
      requestType = com.nils.grpc.cityscore.CityScoreRequest.class,
      responseType = com.nils.grpc.cityscore.CityScoreResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.nils.grpc.cityscore.CityScoreRequest,
      com.nils.grpc.cityscore.CityScoreResponse> getCalculateCityScoreMethod() {
    io.grpc.MethodDescriptor<com.nils.grpc.cityscore.CityScoreRequest, com.nils.grpc.cityscore.CityScoreResponse> getCalculateCityScoreMethod;
      ...
      synchronized (CityScoreServiceGrpc.class) {
        if ((getCalculateCityScoreMethod = CityScoreServiceGrpc.getCalculateCityScoreMethod) == null) {
          CityScoreServiceGrpc.getCalculateCityScoreMethod = getCalculateCityScoreMethod = 
              io.grpc.MethodDescriptor.<com.nils.grpc.cityscore.CityScoreRequest, com.nils.grpc.cityscore.CityScoreResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "cityscore.CityScoreService", "calculateCityScore"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nils.grpc.cityscore.CityScoreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nils.grpc.cityscore.CityScoreResponse.getDefaultInstance()))
  ...
  public static abstract class CityScoreServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void calculateCityScore(com.nils.grpc.cityscore.CityScoreRequest request,
        io.grpc.stub.StreamObserver<com.nils.grpc.cityscore.CityScoreResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.nils.grpc.cityscore.CityScoreRequest,
                com.nils.grpc.cityscore.CityScoreResponse>(
  ...
  public static final class CityScoreServiceBlockingStub extends io.grpc.stub.AbstractStub<CityScoreServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.nils.grpc.cityscore.CityScoreResponse calculateCityScore(com.nils.grpc.cityscore.CityScoreRequest request) {
  ...
  public static final class CityScoreServiceFutureStub extends io.grpc.stub.AbstractStub<CityScoreServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.nils.grpc.cityscore.CityScoreResponse> calculateCityScore(
        com.nils.grpc.cityscore.CityScoreRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALCULATE_CITY_SCORE:
          serviceImpl.calculateCityScore((com.nils.grpc.cityscore.CityScoreRequest) request,
              (io.grpc.stub.StreamObserver<com.nils.grpc.cityscore.CityScoreResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CityScoreServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.nils.grpc.cityscore.CityScore.getDescriptor();
    }
